        ...
        <div className="container">
          <div className="hero">
            <div className="left">
              ...
              <p>
                Upload a patient's chest X-ray and let MediScan AI generate an
                explainable heatmap, confidence score and downloadable medical
                report within seconds.
              </p>

              <div className="doctor">👨‍⚕️ Logged in : Dr. {doctorName}</div>
